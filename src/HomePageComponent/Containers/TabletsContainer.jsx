    ...
    <div className="-z-50">
      ...
      <div className="mx-36">
        <div className="grid grid-cols-4">
          <TabletsItem
            image="HomePageComponents/Tablets/Tablet1.png"
            productName="Tablet 1"
            productPrice="100000/-"
            productStar=""
          />
          <TabletsItem
            image="HomePageComponents/Tablets/Tablet2.png"
          ...
          />
          <TabletsItem
            image="HomePageComponents/Tablets/Tablet3.png"
            productName="Tablet 3"
            productPrice="40000"
            productStar=""
          />
          <TabletsItem
            image="HomePageComponents/Tablets/Tablet4.png"
